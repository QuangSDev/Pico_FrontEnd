  ...
  >
    ...
    <div class="main-content__header">
      <div class="main-content__header--left">
        <div class="main-content__title">Quản lý mặt hàng máy giặt</div>
      </div>
    </div>
    <BaseTable
      detailRoute="/maygiat/maygiat-detail-action"
      detailViewRoute="/maygiat/maygiat-detail-view"
      tableName="MayGiat"
...
export default {
  ...
  mounted() {
    document.title = ACCOUNTING_TEXT.words.MayGiatViewTitle;
    this.$store.dispatch(
      "updateTableHeaders",
